...
function Results() {
  ...
  return (
    <div className="flex flex-col  py-16 gap-16 max-w-[900px]  mx-auto ">
      ...
      <div className="flex flex-col gap-6 md:grid  md:grid-cols-3 md:grid-rows-2 ">
        <div className=" flex gap-6 md:flex-row flex-col md:flex md:row-span-2 md:col-span-1 w-full ">
          <div className=" dark:bg-(--darkgray) rounded-lg border border-neutral-700 p-7 w-full">
            ...
            <p>You've made your move. Now wait and see.</p>
          </div>
        </div>
        <div className="rounded-lg p-7 flex justify-center items-center ">
          ...
          <div className="dark:bg-(--darkgray) rounded-lg p-7 w-full border border-neutral-700">
            {interviewsCount > 0 ? (
              <>
                ...
                <p>They want to meet you. Be ready.</p>
              </>
            ) : (
        ...
        <div className=" flex gap-6 md:flex-row flex-col md:flex border rounded-lg border-neutral-700">
          <div className="dark:bg-(--darkgray) rounded-lg p-7 w-full">
            {offersCount > 0 ? (
              <>
