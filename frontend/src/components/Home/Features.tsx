  ...
  return (
    <div className="py-14">
      ...
      <div className="flex flex-col md:flex-row gap-4 ">
        <div className=" w-full bg-(--greyish) rounded-3xl flex flex-col items-center flex-1  dark:bg-(--darkgray) dark:text-slate-300">
          ...
          <div className="px-8 py-10 w-full ">
            ...
            <NavLink className="font-semibold text-sky-400" to="/applications">
              Explore &gt;
            </NavLink>
          </div>
        </div>
        <div className=" w-full bg-(--greyish) dark:bg-(--darkgray) dark:text-slate-300 rounded-3xl flex flex-col items-center flex-1">
